...
from app.conf.rerank_config import rerank_cfg
...
# 阈值已外置到 app/conf/rerank.yaml 的 dynamic_topk 段：
...
def step_3_topk(scored_docs):
    ...
    阈值来自 app/conf/rerank.yaml 的 dynamic_topk 段（M3）；enabled=false 时退化为固定取满 max_k。
