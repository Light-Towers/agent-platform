"""wenda-data-agent 契约测试：entities / LLM client / settings / state。
...
from wenda_data_agent.entities.metric_info import MetricInfo
from wenda_data_agent.entities.table_info import TableInfo
from wenda_data_agent.entities.value_info import ValueInfo
...
def test_settings_defaults():
    from wenda_data_agent.conf.settings import Settings

    s = Settings()
    assert s.host == "0.0.0.0"
    assert s.port == 8000
    assert s.table_prefix == "wenda_data_agent_"
