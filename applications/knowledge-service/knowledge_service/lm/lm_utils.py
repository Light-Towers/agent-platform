# -*- coding: utf-8 -*-
"""
兼容 shim：桥接 agent_core.llm，保持旧 import 路径 ``from knowledge_service.lm.lm_utils import ...`` 不变。
...
内部读取 ``knowledge_service.conf.lm_config`` 注入 api_key / base_url / temperature，再委托
