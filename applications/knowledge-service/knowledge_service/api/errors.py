...
``knowledge_service/utils/error_response_utils.py`` 与 ``knowledge_service/utils/security_guard_utils.py``。
"""
...
from knowledge_service.core.tracing import get_request_id
from knowledge_service.utils.error_response_utils import error_body, error_code_for_status
from knowledge_service.utils.security_guard_utils import format_validation_error
