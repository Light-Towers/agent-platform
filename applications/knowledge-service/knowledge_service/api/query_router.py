...
from knowledge_service.core.tracing import generate_request_id, set_request_context, start_span, user_query_hash
...
async def chat():
    ...
    chat_html_path = PROJECT_ROOT / "knowledge_service/query_process/page/chat.html"
...
async def health_ready():
    ...
    ready = False
    try:
        from knowledge_service.clients.milvus_utils import milvus_ready
