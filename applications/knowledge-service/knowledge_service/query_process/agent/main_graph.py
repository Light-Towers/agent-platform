...
from knowledge_service.query_process.agent.fanout import wrap_channel_node
from knowledge_service.query_process.agent.nodes.node_answer_output import node_answer_output

# 导入所有节点函数
from knowledge_service.query_process.agent.nodes.node_item_name_confirm import node_item_name_confirm
...
from knowledge_service.query_process.agent.nodes.node_rrf import node_rrf
from knowledge_service.query_process.agent.nodes.node_search_embedding import node_search_embedding
from knowledge_service.query_process.agent.nodes.node_search_embedding_hyde import node_search_embedding_hyde
from knowledge_service.query_process.agent.nodes.node_web_search_mcp import node_web_search_mcp
...
builder.add_node("node_search_embedding", wrap_channel_node(node_search_embedding, "embedding"))  # 向量搜索
builder.add_node("node_search_embedding_hyde", wrap_channel_node(node_search_embedding_hyde, "hyde"))
builder.add_node("node_query_kg", wrap_channel_node(node_query_kg, "kg"))
builder.add_node("node_web_search_mcp", wrap_channel_node(node_web_search_mcp, "web"))
