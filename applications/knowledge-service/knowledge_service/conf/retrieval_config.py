# -*- coding: utf-8 -*-
"""
检索链路配置（M3，方案 §7.2）：读取 ``knowledge_service/conf/retrieval.yaml``。
...
环境变量 ``KNOWLEDGE_RETRIEVAL_YAML`` 可覆盖 yaml 路径（部署 / 单测隔离用）。
"""
...
# 环境变量覆盖键
_RETRIEVAL_YAML_ENV = "KNOWLEDGE_RETRIEVAL_YAML"
