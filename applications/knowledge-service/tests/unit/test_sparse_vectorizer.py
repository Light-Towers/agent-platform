# -*- coding: utf-8 -*-
"""
test_sparse_vectorizer.py —— 验证 knowledge_service/lm/sparse_vectorizer.py 的零依赖稀疏向量生成。
...
from knowledge_service.lm.sparse_vectorizer import _token_id, build_sparse_vector, build_sparse_vectors, tokenize
