...
| 4 | Adapters + Middleware | ✅ PASS | `TodoListMiddleware`/`RubricMiddleware` import OK；wenda-adapter 已于 2026-08 退役（由 wenda-data-agent 直连替代）；kefu-adapter 已于 2026-08 移除（迁移至 kefu-service 直连） |
