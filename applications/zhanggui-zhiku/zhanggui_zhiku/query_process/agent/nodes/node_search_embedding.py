...
from zhanggui_zhiku.clients.milvus_utils import create_hybrid_search_requests, hybrid_search, get_milvus_client
...
def node_search_embedding(state):
    ...
    # M3（方案 §7.2）：稠密/稀疏评分权重从 zhanggui_zhiku/conf/retrieval.yaml 读取（hybrid.dense_weight/sparse_weight）
    res = hybrid_search(
        client=client,
